...
return [
    'cities' => [
        ...
        'Bolu' => ['Dörtdivan', 'Gerede', 'Göynük', 'Kıbrıscık', 'Mengen', 'Merkez', 'Mudurnu', 'Seben', 'Yeniçağ'],
        ...
        'Erzurum' => ['Aşkale', 'Aziziye', 'Çat', 'Hınış', 'Horasan', 'İspir', 'Karaçoban', 'Karayazı', 'Köprüköy', 'Narman', 'Oltu', 'Olur', 'Palandöken', 'Pasinler', 'Pazaryolu', 'Şenkaya', 'Tekman', 'Tortum', 'Uzundere', 'Yakutiye'],
        ...
        'Tekirdağ' => ['Çerkezköy', 'Çorlu', 'Ergene', 'Hayrabolu', 'Kapakli', 'Malkara', 'Marmaraereğlisi', 'Muratlı', 'Saray', 'Süleymanpaşa', 'Şarköy'],
