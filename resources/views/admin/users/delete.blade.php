<x-admin-layout>
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold mb-8 text-red-600">Kullanıcıyı Sil</h1>
            ...
            <div class="bg-red-50 border border-red-200 p-6 rounded-lg">
                ...
                <div class="mb-6 p-4 bg-white rounded border">
                    <h3 class="font-medium text-gray-900 mb-2">Silinecek Kullanıcı:</h3>
                ...
                <div class="mb-6 p-4 bg-red-100 rounded border border-red-300">
                    ...
                    <ul class="list-disc list-inside text-sm text-red-700 space-y-1">
                        <li>Kullanıcının hesabı kalıcı olarak silinecek</li>
                ...
                <form action="{{ route('admin.users.destroy', $user) }}" method="POST">
                    ...
                    <div class="mb-6">
                        <label for="reason" class="block text-sm font-medium text-red-700 mb-2">Silme Sebebi *</label>
                        <textarea name="reason" id="reason" rows="4" required
                                  class="w-full border-red-300 rounded-md shadow-sm focus:border-red-500 focus:ring-red-500"
                                  placeholder="Kullanıcının neden silindiğini açıklayın...">{{ old('reason') }}</textarea>
                        @error('reason')
                    ...
                    <div class="mb-6">
                        <label class="flex items-center">
                            ...
                            <span class="ml-2 text-sm text-red-700">Bu kullanıcıyı kalıcı olarak silmek istediğimi onaylıyorum</span>
                        </label>
                    </div>
