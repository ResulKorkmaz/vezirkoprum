                ...
                <div class="flex justify-between h-20">
                    ...
                    <div class="hidden md:flex items-center space-x-4">
                        ...
                        <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false">
                            <div class="flex items-center space-x-3 px-4 py-2 rounded-xl bg-gray-50 border border-gray-200 cursor-pointer hover:bg-gray-100 transition-colors duration-200">
                            ...
                            <div x-show="open" 
                                 ...
                                 class="absolute right-0 mt-2 w-56 rounded-xl shadow-lg bg-white border border-gray-200 z-50">
                                <div class="py-2">
