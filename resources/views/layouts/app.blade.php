                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            ...
                            @auth
                                <li>
                                    <a href="{{ route('profile.edit') }}" class="text-gray-300 transition-colors duration-200 flex items-center" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#D1D5DB'">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="{{ route('posts.index') }}" class="text-gray-300 transition-colors duration-200 flex items-center" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#D1D5DB'">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="{{ route('messages.index') }}" class="text-gray-300 transition-colors duration-200 flex items-center" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#D1D5DB'">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                                        </svg>
                                        Mesajlarım
                                ...
                                <li>
                                    <a href="{{ route('whatsapp.index') }}" class="text-gray-300 transition-colors duration-200 flex items-center" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#D1D5DB'">
                            ...
                            @else
                                <li>
                                    <a href="{{ route('login') }}" class="text-gray-300 transition-colors duration-200 flex items-center" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#D1D5DB'">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="{{ route('register') }}" class="text-gray-300 transition-colors duration-200 flex items-center" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#D1D5DB'">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <svg class="w-5 h-5 mr-3 mt-0.5 flex-shrink-0" style="color: #B76E79;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button onclick="openContactModal()" class="w-full text-white px-4 py-3 rounded-lg font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 flex items-center justify-center" style="background-color: #B76E79;" onmouseover="this.style.backgroundColor='#A85D68'" onmouseout="this.style.backgroundColor='#B76E79'">
                    ...
                    <div class="md:flex md:items-center md:justify-between">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-gray-400 text-sm mt-2">
                                    <a href="https://www.resulkorkmaz.com" target="_blank" rel="noopener noreferrer" 
                                       class="font-medium transition-colors duration-200" style="color: #B76E79;" onmouseover="this.style.color='#A85D68'" onmouseout="this.style.color='#B76E79'">
                        ...
                        <div class="mt-4 flex justify-center md:mt-0 md:order-1">
                            <div class="flex space-x-6">
                                <a href="{{ route('privacy') }}" class="text-gray-400 text-sm transition-colors duration-200" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#9CA3AF'">
                                    Gizlilik Politikası
                                </a>
                                <a href="{{ route('terms') }}" class="text-gray-400 text-sm transition-colors duration-200" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#9CA3AF'">
                                    Kullanım Şartları
                                </a>
                                <a href="{{ route('kvkk') }}" class="text-gray-400 text-sm transition-colors duration-200" onmouseover="this.style.color='#B76E79'" onmouseout="this.style.color='#9CA3AF'">
                                    KVKK
                                </a>
                            </div>
                        </div>
                    ...
                    <form id="contactForm" onsubmit="submitContactForm(event)">
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" id="contact_name" name="name" required 
                                       class="w-full rounded-lg shadow-sm transition-colors" style="border-color: rgba(183, 110, 121, 0.3);" onfocus="this.style.borderColor='#B76E79'; this.style.boxShadow='0 0 0 2px rgba(183, 110, 121, 0.2)'" onblur="this.style.borderColor='rgba(183, 110, 121, 0.3)'; this.style.boxShadow='none'"
                        ...
                        <div class="flex space-x-3 mt-6">
                            ...
                            <button type="submit" id="contactSubmitBtn"
                                    class="flex-1 px-4 py-3 text-white font-semibold rounded-lg transition-colors flex items-center justify-center" style="background-color: #B76E79;" onmouseover="this.style.backgroundColor='#A85D68'" onmouseout="this.style.backgroundColor='#B76E79'">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <script>
            ...
            async function submitContactForm(event) {
                ...
                try {
                    ...
                    await addRecaptchaToForm(form, 'contact');
